...
function createValidator() {
  $.validator.addMethod("notEqualTo", function (value, element, param) {
    var target = $(param);
    if (value) return value != target.val();else return this.optional(element);
  }, "Does not match");
...
var MainContent = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'container banner_button' },
        React.createElement(
          'div',
...
var CreateEvent = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'form',
      { className: 'section create_event_form' },
      React.createElement(
        'h1',
        null,
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'six columns' },
          React.createElement('input', { className: 'u-full-width', type: 'text', id: 'event_name_header', name: 'event_name_header', required: true })
        )
      ),
      React.createElement(
        'div',
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'six columns' },
          React.createElement('input', { className: 'u-full-width', list: 'event_type_list', id: 'event_type', name: 'event_type', required: true }),
          React.createElement(
            'datalist',
            { id: 'event_type_list' },
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'six columns' },
          React.createElement('input', { className: 'u-full-width', type: 'text', id: 'event_location_input', name: 'event_location_input', required: true }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'six columns' },
            React.createElement('textarea', { className: 'u-full-width', name: 'event_message', id: 'event_message', formnovalidate: true })
          )
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            'div',
            { className: 'six columns' },
            React.createElement('textarea', { className: 'u-full-width', name: 'event_guests', id: 'event_guests', formnovalidate: true })
          )
        )
      ),
      React.createElement('hr', null),
